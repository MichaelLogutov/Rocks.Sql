...
{
    [TestClass]
    public class MsSqlPredicatesGuidExtensionsTests
    {
        [TestMethod]
        ...
        public void AddIn_TwoParameters_AddsCorrectPredicate ()
        {
            ...
            var sut = new SqlClause ();
            var fixture = new FixtureBuilder ().Build ();
            var value1 = fixture.Create<Guid> ();
            var value2 = fixture.Create<Guid> ();
        ...
        public void AddIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddIn ("Id", "@x", (IEnumerable<Guid>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
        ...
        public void AddNotIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddNotIn ("Id", "@x", (IEnumerable<Guid>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
