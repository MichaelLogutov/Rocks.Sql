...
{
    [TestClass]
    public class MsSqlPredicatesIntExtensionsTests
    {
        [TestMethod]
        ...
        public void AddIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddIn ("Id", "@x", (IEnumerable<int>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
        ...
        public void AddNotIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddNotIn ("Id", "@x", (IEnumerable<int>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
