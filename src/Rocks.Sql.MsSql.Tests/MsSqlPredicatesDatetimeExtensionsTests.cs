...
{
    [TestClass]
    public class MsSqlPredicatesDateTimeExtensionsTests
    {
        [TestMethod]
        ...
        public void AddIn_TwoParameters_AddsCorrectPredicate ()
        {
            ...
            var sut = new SqlClause ();
            var fixture = new FixtureBuilder ().Build ();
            var value1 = fixture.Create<DateTime> ();
            var value2 = fixture.Create<DateTime> ();
        ...
        public void AddIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddIn ("Id", "@x", (IEnumerable<DateTime>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
        ...
        public void AddNotIn_NoParameters_AddsNothing ()
        {
            ...
            // act
            sut.AddNotIn ("Id", "@x", new DateTime[0]);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
        ...
        public void AddNotIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddNotIn ("Id", "@x", (IEnumerable<DateTime>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
