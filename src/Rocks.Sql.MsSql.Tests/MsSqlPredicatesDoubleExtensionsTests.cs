...
{
    [TestClass]
    public class MsSqlPredicatesDoubleExtensionsTests
    {
        [TestMethod]
        ...
        public void AddIn_TwoParameters_AddsCorrectPredicate ()
        {
            ...
            var value2 = fixture.Create<double> ();
        ...
        public void AddIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddIn ("Id", "@x", (IEnumerable<double>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
        ...
        public void AddNotIn_NoParameters_AddsNothing ()
        {
            ...
            // act
            sut.AddNotIn ("Id", "@x", new double[0]);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
        ...
        public void AddNotIn_Null_AddsNothing ()
        {
            ...
            // act
            sut.AddNotIn ("Id", "@x", (IEnumerable<double>) null);
            var sql = sut.GetSql ();
            var parameters = sut.GetParameters ();
