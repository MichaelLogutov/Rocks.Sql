...
namespace Rocks.Sql
{
    ...
    public static class SqlClauseBuilder
    {
        ...
        /// <summary>
        ///     Creates new <see cref="SqlClause" /> to represent the sql predicate clause (like condition in "where").
        /// </summary>
        [NotNull]
        public static SqlClause Predicate (string logic = "and")
        {
            return new SqlClause ().AsInlinePredicatesClause (logic);
        }
