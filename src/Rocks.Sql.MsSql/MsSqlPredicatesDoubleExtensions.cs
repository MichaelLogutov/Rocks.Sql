...
{
    public static class MsSqlPredicatesDoubleExtensions
    {
        /// <summary>
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<double> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params double[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<double>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params double[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<double>) values);
        }
