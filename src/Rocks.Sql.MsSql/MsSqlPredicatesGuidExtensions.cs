...
namespace Rocks.Sql.MsSql
{
    public static class MsSqlPredicatesGuidExtensions
    {
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<Guid> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params Guid[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<Guid>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params Guid[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<Guid>) values);
        }
