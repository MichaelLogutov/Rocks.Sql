...
{
    public static class MsSqlPredicatesShortExtensions
    {
        /// <summary>
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<short> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params short[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<short>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params short[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<short>) values);
        }
