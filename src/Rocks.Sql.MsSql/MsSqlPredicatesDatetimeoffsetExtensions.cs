...
{
    public static class MsSqlPredicatesDateTimeOffsetExtensions
    {
        /// <summary>
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<DateTimeOffset> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params DateTimeOffset[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<DateTimeOffset>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params DateTimeOffset[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<DateTimeOffset>) values);
        }
