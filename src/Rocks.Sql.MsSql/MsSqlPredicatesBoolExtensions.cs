...
{
    public static class MsSqlPredicatesBoolExtensions
    {
        /// <summary>
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<bool> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params bool[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<bool>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params bool[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<bool>) values);
        }
