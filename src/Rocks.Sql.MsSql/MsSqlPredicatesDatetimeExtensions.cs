...
{
    public static class MsSqlPredicatesDateTimeExtensions
    {
        /// <summary>
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<DateTime> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params DateTime[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<DateTime>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params DateTime[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<DateTime>) values);
        }
