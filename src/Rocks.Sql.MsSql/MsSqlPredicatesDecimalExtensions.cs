...
{
    public static class MsSqlPredicatesDecimalExtensions
    {
        /// <summary>
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] IEnumerable<decimal> values)
        {
            if (values == null)
                return sqlClause;
        ...
        public static SqlClause AddIn (this SqlClause sqlClause,
                                       [NotNull] string columnName,
                                       [NotNull] string parameterName,
                                       [CanBeNull] params decimal[] values)
        {
            return sqlClause.AddIn (columnName, parameterName, (IEnumerable<decimal>) values);
        }
        ...
        public static SqlClause AddNotIn (this SqlClause sqlClause,
                                          ...
                                          [CanBeNull] params decimal[] values)
        {
            return sqlClause.AddNotIn (columnName, parameterName, (IEnumerable<decimal>) values);
        }
